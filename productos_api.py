...
def obtener_productos():
    ...
    orden_dirs = {'ASC': 'ASC', 'DESC': 'DESC'}

    orden_col = orden_cols.get(orden, 'nombre')
    orden_direction = orden_dirs.get(orden_dir.upper(), 'ASC')
    ...
    try:
        ...
        query += f' ORDER BY {orden_col} {orden_direction}'
